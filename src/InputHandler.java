...
public class InputHandler implements ActionListener {
	...
	private void setupKeys() {
		...
		//Add secret easter egg key
		inputManager.addMapping("Secret", new KeyTrigger(KeyInput.KEY_E ));
		inputManager.addListener(this, "Secret");
	}
